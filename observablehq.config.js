...
export default {
  ...
  pages: [
        {name: "In Depth Anaylsis", path: "/analysis"},
  ...
  //header: ["Premier League DashBoard"],// what to show in the header (HTML)
    ...
    header: `<div style="display: flex; flex-grow: 1; align-items: center; justify-content: space-between; white-space: nowrap;">
      ...
      <div style="display: flex; align-items: center; gap: 1rem; font-size: 14px; ">
        <a class="hide-if-small" target="_blank" data-decoration="★" title="${stargazers_count.toLocaleString(
          "en-US"
        )} GitHub stars" href="https://github.com/Marc-Chiu/Prem_dashboard"><span>Source Code ${
        ...
        <a class="hide-if-large" target="_blank" title="${stargazers_count.toLocaleString(
          "en-US"
        )} GitHub stars" href="https://github.com/Marc-Chiu/">
